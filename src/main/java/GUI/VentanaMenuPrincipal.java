    ...
    public VentanaMenuPrincipal() {
        ...
        boton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                dispose();
                VentanaSalidaProductos ventanaSalidaProductos = new VentanaSalidaProductos();
                ventanaSalidaProductos.setVisible(true);
            }
        });
        ...
        boton2.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                dispose();
                VentanaEntradaProductos ventanaEntradaProductos = new VentanaEntradaProductos();
                ventanaEntradaProductos.setVisible(true);
